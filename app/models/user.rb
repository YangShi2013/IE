...
class User < ActiveRecord::Base
  ...
  #def self.open_spreadsheet(file)
    ...
    #when ".csv" then Csv.new(file.original_filename, nil, :ignore)
    #when ".xls" then Roo::Excel.new(file.original_filename, nil, :ignore)
    #when ".xlsx" then Roo::Excelx.new(file.original_filename, nil, :ignore)
